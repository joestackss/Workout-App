...
class BMIActivity1 : AppCompatActivity() {
    ...
    private var binding: ActivityBmiactivity1Binding? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        //Todo 4 inflate the layout
        binding = ActivityBmiactivity1Binding.inflate(layoutInflater)
        ...
        binding?.btnCalculateUnits?.setOnClickListener {
            ...
            if (validateMetricUnits()) {
                ...
                Toast.makeText(this@BMIActivity1, "Please enter valid values.", Toast.LENGTH_SHORT)
                    .show()
            }
        }
        // END
